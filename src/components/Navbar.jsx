...
const Navbar = () => {
  ...
  let lightURLTheme =
    "https://www.iconbolt.com/iconsets/fluent-emoji-flat/sun.svg";
  let darkURLTheme =
    "https://www.iconbolt.com/iconsets/fluent-emoji-flat/crescent-moon.svg";
    ...
    <div className={`navbar ${theme}`}>
      <div className="navbar-container">
        <div className="navbar-topside">
          ...
          <p className="logo-text">Sve za Fudbal.com</p>
